...
echo'<div class="menu">';
$host = "seclub.org";
$path = "/mod/goro.php?".$_SERVER['QUERY_STRING'];;
...
$file = str_replace('mod/goro.php','moduls/horo.php',$file);
$file = str_replace('<span style="color:#E7C403; font-size: small">Гороскоп предоставлен <a href="http://www.hyrax.ru">Hyrax.ru</a></span><br/>','',$file);
$file = str_replace('/mod/serv.php?sesid','index.php?sesid',$file);
